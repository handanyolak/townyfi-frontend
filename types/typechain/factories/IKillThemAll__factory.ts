...
import type { IKillThemAll, IKillThemAllInterface } from "../IKillThemAll";
...
export class IKillThemAll__factory {
  static readonly abi = _abi;
  static createInterface(): IKillThemAllInterface {
    return new Interface(_abi) as IKillThemAllInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IKillThemAll {
    return new Contract(address, _abi, runner) as unknown as IKillThemAll;
  }
}
