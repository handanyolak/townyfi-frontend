...
import type {
  IKillThemAll,
  IKillThemAllInterface,
} from "../../../contracts/game/IKillThemAll";
...
export class IKillThemAll__factory {
  ...
  static createInterface(): IKillThemAllInterface {
    return new utils.Interface(_abi) as IKillThemAllInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IKillThemAll {
    return new Contract(address, _abi, signerOrProvider) as IKillThemAll;
  }
}
